...
namespace Holidayview.Infrastructure.Migrations
{
    ...
    [Migration("20211103204744_DeactiveVacationLeaveBalanceDisableCompanieTables")]
    partial class DeactiveVacationLeaveBalanceDisableCompanieTables
    {
            ...
            modelBuilder.Entity("Holidayview.Domain.Model.Director", b =>
                {
                    b.HasOne("Holidayview.Domain.Model.Customer", "Customer")
                        .WithOne("Director")
                        .HasForeignKey("Holidayview.Domain.Model.Director", "CustomerRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
